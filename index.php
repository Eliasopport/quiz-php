...
<form action="result.php" method="post">
    ...
    <?php include "./includes/input-questions-yes-or-no.php";?>
    ...
    <select class="form-select" id="inputGroupSelect01" name="mammal">
      ...
      <?php
        ...
        */
        $mammals = array("Rind", "Pferd", "Ziege", "Mensch", "Hund", "Kater Munz");
        $i = 0;
        $lenght = count($mammals);
        while ($i < $lenght) {
            $mammal = $mammals[$i];
           echo "<option selected>$mammal</option>";
